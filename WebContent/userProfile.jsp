			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body text-center">
						<img src="images/profile-1.jpg" class="rounded-circle img-fluid"
							style="width: 150px;">
						<h5 class="my-3">
							Hello
							<%=user.getName()%>,
					...
					<div class="card-body p-0">
						<ul class="list-group list-group-flush rounded-3">
							...
							<li
								...
								<h1>Contact us if any updation requrired</h1>
								<h4>tribalhandicrafts@kluniversity.in</h4>
								<h4>Phone: +91 86453 50200</h4>
							</li>
						</ul>
					</div>
				</div>
