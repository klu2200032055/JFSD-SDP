					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="Necklaces"
								<%="Necklaces".equalsIgnoreCase(ptype) ? "selected" : ""%>>Necklaces</option>
								
							<option value="toys"
								<%="toys".equalsIgnoreCase(ptype) ? "selected" : ""%>>Toys</option>
								
							<option value="Wall Hangings"
								<%="Wall Hangings".equalsIgnoreCase(ptype) ? "selected" : ""%>>Wall Hangings</option>
								
							<option value="Pots"
								<%="Pots".equalsIgnoreCase(ptype) ? "selected" : ""%>>Pots</option>
								
							<option value="Bangles"
								<%="Bangles".equalsIgnoreCase(ptype) ? "selected" : ""%>>Bangles</option>
								
							<option value="Mats"
								<%="Mats".equalsIgnoreCase(ptype) ? "selected" : ""%>>Mats</option>
								
							<option value="others"
								<%="others".equalsIgnoreCase(ptype) ? "selected" : ""%>>others</option>
